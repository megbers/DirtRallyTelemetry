...
//String settingsPath = "\\SettingsApp\\data\\settings";
String settingsPath = "/Users/megbers/Documents/personal/workspaces/DirtRallyTelemetry/Reference/Cortextual/src/main/resources/data/settings";
String UDPSettingsPath = "/Users/megbers/Documents/personal/workspaces/DirtRallyTelemetry/Reference/Cortextual/src/main/resources/data/connection.cfg";
...
public void setup(){
  ...
  if (cKey) {
    img=loadImage("bgy.png");
  } else {
    img=loadImage("bg.png");
  }
  imgDrag=loadImage("bgw.png");
  kPanel=loadImage("kPanel.png");
  bLightOn=loadImage("bLightOn.png");
  bLightOff=loadImage("bLightOff.png");
  if (!compactMode) {
    wheelImg=loadImage("wheel.png");
  } else {
    wheelImg=loadImage("wheelCompact.png");
  }
...
public void updateControllers(float utTime, float ulapTime, float udistance, float uposx, float uposy, float uspeed, float ususpAL, float ususpAR, float ususpFL,
  ...
  if (colorSpeedo) cp5.getController("speed").setColorForeground(color(255,255 - map(uspeed, 0, maxSpeed, 0, 255),255 - map(uspeed, 0, maxSpeed, 0, 255)));
